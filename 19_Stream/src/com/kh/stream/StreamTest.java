...
public class StreamTest {
	 ...
	 * 스트림은 요소를 검색, 필터링 하거나 값을 처리하는데 목적이 있음.
	 * 
	 * 스트림의 특징
	...
	public static void main(String[] args) {
		...
		// forEach반복문을 통해 배열 요소에 하나씩 접근 그 안에 담긴값을 모두 더하고 싶음.
		int sum = 0;
		String test = "지역변수";
...
//			sum += num;
		...
		pList.add(new Product("아이폰 14",1450000,1,"애플"));
