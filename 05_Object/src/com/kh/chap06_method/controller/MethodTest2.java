...
public class MethodTest2 {
	 ...
	 * 
	 *   - 호출 시 객체 생성할 필요가 없음
	 *   - 프로그램 시작시에 정적 메모리 영역에 메소드가 저장되어 있을것 이기 때문.
	...
	public static String method2() {
		...
		return "매개변수는 없고요, 반환값은 있는 메소드 입니다.";
	}
	...
	public static int method4(int num1) {
		...
		/*
		 * static 메서드안에서는 static이 아닌 field 멤버가 접근이 불가능하다.
		 * 스태틱 메서드는 프로그램 시작시 정적 메모리영역에 들어가게 되는데
		 * 이때 스태틱으로 선언된 필드(전역변수)도 함께 정적 메모리 영역에 들어갈것.
