...
public class Run {
	 ...
	 * 	캡슐화를 하지않으면 : 외부로부터 직접 접근이 가능하기 때문에 함부로 값이 변질되너가 조회를 막지 못하는 문제 발생.
	 * 
	 * 	1) 정보 은닉 : private
...
//		hong.name = "홍성빈"; // the filed Student.name is not visible
//		hong.age = 20;
//		hong.height = 166.6;
		...
		hong1.setName("홍성빈");
		hong1.setAge(31);
		hong1.setHeight(180.5);
		
		System.out.println(hong1.information());
	}
