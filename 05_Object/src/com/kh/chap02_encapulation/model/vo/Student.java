...
public class Student {
	 ...
	 */
	// setter
	// 해당 필드에 대입 하고자 하는 값을 전달받아 해당필드에 대입시켜주는 기능의 메소드
	...
	public void setName(String name) {
		...
		// name = name;
		// 매개변수 name = 매개변수name을 대입하는 형식임.
		// 왜? 필드명과 매개변수명이 동일한 경우 {} 영역 내에서는 해당영역에서 만들어진 변수가 좀 더 우선순위가 높기때문.
		// 객체의 name에 접근하려면 this를 사용해야함.
		// this 에는 생성된 객체의 "주소값" 이 담겨있음.
	...
	// 키값을 기록 및 수정할 수 있는 기능의 메소드(height 필드에 값을 대입 하기위한 용도)
	...
	public String getName() { // void : 반환하는 값이 없을 경우에 작성.
		...
		return name; // return 반환값; -> 반환값을 나를 호출한 메소드의 위치에 전달 하겠다.
	}
