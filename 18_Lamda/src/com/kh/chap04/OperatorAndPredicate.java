...
public class OperatorAndPredicate {
	...
	public static void main(String[] args) {
		...
		pList.add(new Product("갤럭시 z플립4",1350000,0));
		pList.add(new Product("갤럭시 z플립3",1200000,50));
		pList.add(new Product("갤럭시 z플립2",1000000,30));
		pList.add(new Product("갤럭시 z플립1",900000,15));
		pList.add(new Product("아이폰 14",1500000,0));
		pList.add(new Product("아이폰 13",1350000,40));
		pList.add(new Product("아이폰 11 Pro",1100000,30));
