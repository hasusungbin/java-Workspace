...
public class Run {
	...
	public static void main(String[] args) {
		...
		Book bk = new Book("수학의 정석","홍성빈",7000);
		
		/*
		 * 출력문 안에 레퍼런스(참조자료형) 변수를 제시해서 출력하고자 할 때
		 * 내부적으로 JVM 이 자동으로 toString() 메소드를 호출함.
		 * 
		 * 부모클래스인 Object 클래스에 있는 toString()
		 * 해당 래퍼런스탕비의 풀클래스명 + @ + 해당객채의 주소값의 16진수
		 * 
		...
		// 메소드 변경 후
		// 책 제목 : 수학의 정석, 책 저자 : 홍성빈, 책 가격 :7000
