...
public class F_Logical {
	 ...
	 * 
	 * OR 연산자 : 논리값 || 논리값
	 * 				왼쪽, 오른쪽 논리값중 어느 하나라도 TRUE 면 최종결과가 TRUE
	 * 
	 * 
	 * 
	 */
	...
	public void method1() { 
		...
		System.out.print("정수값 한개 입력 하세요. : ");
		int num = sc.nextInt();
	...
	public void method2() {
		...
		// 사용자가 입력한 값이 1이상 100 이하 입니까? true/false
		
		Scanner sc = new Scanner(System.in);
		
		System.out.print("사용자가 입력한 정수 값 : ");
		int num = sc.nextInt();
	...
	public void method3() {
		...
		System.out.print("계속 진행하시려면 y 또는 Y 를 입력하세요. : ");
		 ...
		 *  || (OR) : 또는 , ~ 이거나
		 *  
		 *  두개의 조건 중 하나라도 TRUE 일 경우 최종 결과값은 true
		 *  두개의 조건이 모두 false 일 경우 최종 결과값은 false
		 */
	...
	public void method4() {
		 ...
		 * 실행할 때 오류는 나지 않지만, result1 결과값이 어차피 false 인데 왜 작성한 구문인지 물어보는것
		 */
