...
public class ControlPractice {
	...
	public void practice4() {
		...
		default : System.out.println(month+"잘못 입력된 달 입니다.");
		}
	...
	public void practice5() {
		...
		//1. 아이디 값을 잘 입력했는지 체크를 할것.
		//2. 아이디 값이 잘 입력되었다면, 비밀번호를 잘 입력했는지 체크를 할것.
		if(id.equals("binryun")) { // 아이디값이 잘 입력됐는지 확인
			if(pw.equals("dkvmflzk1020@")) {
	...
	public void practice6() {
		...
		switch (grade) {
		case "관리자" : System.out.print("회원관리 , 게시글 관리 , 게시글 작성 ,");
	...
	public void practice11() {
		...
		if (pw > 999 && pw < 9999) {
			...
			int third = (pw / 100) % 10; // 백의 자릿수 구하기
			int forth = (pw / 1000) % 10; // 천의 자릿수 구하기
			// 중복값이 있는지 처리하기
