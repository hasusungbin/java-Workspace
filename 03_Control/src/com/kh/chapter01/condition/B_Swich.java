...
public class B_Swich {
	 ...
	 * 					// 위의 값1, 값2, 값n... 앞으로 동등비교를 할 대상과 하나도 일치하지 않다면, default 내의 실행할 코드가 실행된다.
	 * 
	 * 
	 * }
	 * 
	 * switch 믄 자주 사용되진 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과가 수행되어야 하는경우
	 * ex) 키보드 입력, 마우스 입력 등.
	 */
...
//		}
	...
	public void method2() {
		...
		System.out.println("과일명을 입력하세요.(사과, 바나나, 복숭아) : ");
	...
	public void method4() {
		...
		Scanner sc = new Scanner(System.in);
		System.out.println("1월 ~ 12월 사이의 월 입력 : ");
		...
		case 8 : 
		case 10 : 
		case 12 : System.out.println("해당 달은 31일 입니다."); break;
		case 4 : 
		case 6 : 
		case 9 :
		case 11 :System.out.println("해당 달은 30일 입니다."); break;
		case 2 : System.out.println("해당 달은 28일 또는 29일 입니다."); break;
