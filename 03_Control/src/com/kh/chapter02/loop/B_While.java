...
public class B_While {
	 ...
	 * 
	 * [초기식;] // 필수가 아님.
	 * while(조건식){ // 조건이 true 일 경우 해당 구문들을 반복적으로 실행, 조건식 내용에 true 를 작성시 무한반복함.
	 * 		반복적으로 실행할 코드
	 * 		[증감식]; // 필수는 아님
	 * 		}
	 * 
	 * for 문과 다르게 초기식, 증감식 필수가 아님.
	 * 분기문에서 초기식 , 증감식 없이 작성하는법을 배울 예정.
	 */
	
	
	public void method1() {
		// for문을 while 문으로 , while 문을 for 문으로 표현 할 수 있음.
...
//		}
	...
	public void method4() {
		...
		int i = 0;
		while(i < str.length()) {
			System.out.println("문자열의 길이 : "+str.charAt(i));
			i++;
		}
	}
		 ...
		 * 		실행할 코드
		 * } while(조건식); // 조건식의 결과가 true 면 실행할 코드를 다시 실행
