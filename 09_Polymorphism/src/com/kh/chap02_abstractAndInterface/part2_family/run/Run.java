package com.kh.chap02_abstractAndInterface.part2_family.run;

import com.kh.chap02_abstractAndInterface.part2_family.model.vo.*;
...
public class Run {
	...
	public static void main(String[] args) {
		// 인터페이스 적용 전.
//		Person p = new Person();
//		Person p1 = new Mother("홍엄마",74,60,"출산");
//		Person p2 = new Baby("홍애기",3.5,60);
//		
...
//		System.out.println(p2);
		...
		// 인터페이스 적용 후
		Basic b1 = new Mother("홍엄마",77,70,"출산");
		Basic b2 = new Baby("홍아기",4.5,70);
		 ...
		 * 일반메소드여부| O							| X
		 * ------------------------------------------------------
		 * 필드		| 일반필드 가질 수 있음.			| 상수필드만 가질 수 있음(묵지석 public abstract final)
		 * 
		 * 
		 * 배운 순서
