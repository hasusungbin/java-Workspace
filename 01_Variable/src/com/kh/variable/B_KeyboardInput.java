...
public class B_KeyboardInput {
	...
	public void inputTest1() {
		...
		String name = sc.nextLine(); // 사용자가 엔터까지 입력할 때 까지 대기상태를 유지함.
		...
		System.out.println("사는곳은 어디 입니까? : " );
		String address = sc.nextLine();
		
		System.out.println("당신의 키는 몇 센치미터 입니까? : ");
	...
	/*
	 * 정리
	 * 1. 콘솔 창(모니터)에 출력하기 위해 : System.out.println[ln]()메소드 이용
